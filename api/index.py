...
def get_cached_knowledge():
    ...
    # Since you're only hosting the backend for local app connection,
    # you can return empty or implement a simple in-memory storage
    return []
...
def add_knowledge():
    ...
    # Your local app can handle data persistence if needed
...
def get_knowledge():
    ...
    # Your local app can maintain its own knowledge storage
    return jsonify([])
