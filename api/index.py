        ...
        try:
            if client:
                ...
                if "hello" in user_input_lower or "hi" in user_input_lower:
                    ...
                    if "rojohn" in user_input_lower or "de guzman" in user_input_lower or "michael" in user_input_lower:
                        chatbot_message = "I was created by **Rojohn Michael De Guzman** from our IT department! He's a talented developer who built me to provide IT support for Casto Travel Philippines. 🚀"
                    else:
